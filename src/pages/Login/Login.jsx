        ...
        <div className='my-container w-full min-h-screen flex flex-col lg:flex-row items-start'>
            ...
            <div className='lg:w-1/2 h-full  bg-[#f5f5f5]  flex flex-col p-20 justify-between'>
                ...
                <div className='w-full flex flex-col my-4'>
                    ...
                    <button className='w-full text-[#060606] font-semibold my-2 bg-white border-2 border-black rounded-md p-4 text-center flex items-center justify-center cursor-pointer'>Register  </button>
                </div>
